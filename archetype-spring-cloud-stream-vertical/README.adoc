...
En este proyecto de ejemplo tendremos dos módulos verticales principales: `player` y `confirmation`, además de un módulo `shared` para código común.
...
----
src/
 ├── src/labcabrera/sample/archetype
 │   ├── confirmation
 │   ├── player
 │   └── shared
----
